...
public class SendToWXActivity extends Activity {
    ...
    private void initView() {
        ...
        findViewById(R.id.send_text).setOnClickListener(v -> {
            ...
            MMAlert.showAlert(SendToWXActivity.this, "send text", editor, getString(R.string.app_share), getString(R.string.app_cancel), (dialog, which) -> {
        ...
        findViewById(R.id.get_info).setOnClickListener(v -> {
            if (user_openId == null || accessToken == null) {
                ...
                Intent intent = new Intent(SendToWXActivity.this, WxUserInfoActivity.class);
        ...
        findViewById(R.id.pay).setOnClickListener(v -> testPay());
    }
