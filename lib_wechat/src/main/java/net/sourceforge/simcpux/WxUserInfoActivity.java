...
public class WxUserInfoActivity extends Activity {
    private static String TAG = "MicroMsg.WxUserInfoActivity";
    ...
    private static class MyHandler extends Handler {
        private final WeakReference<WxUserInfoActivity> userInfoActivityWR;

        public MyHandler(WxUserInfoActivity userInfoActivity) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wx_user_info_ui);
    }
